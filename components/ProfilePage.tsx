...
export default function ProfilePage() {
  ...
  const handleImageFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file.size > 1024 * 1024) {
      setError('รูปภาพต้องมีขนาดไม่เกิน 1MB');
      return;
    }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1E293B]/20 focus:border-[#1E293B]"
              />
            </div>
            ...
            <div>
              ...
              {imageMode === 'url' ? (
                <input
                  ...
                  placeholder="https://..."
                  className="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1E293B]/20"
                />
              ) : (
                <label className="flex items-center justify-center w-full h-16 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-gray-300 bg-gray-50">
            ...
            <div className="flex gap-3 pt-1">
              ...
              <button
                onClick={handleSave}
                className="flex-1 py-2.5 bg-[#1E293B] text-white rounded-xl text-sm font-medium hover:bg-[#0F172A]"
              >
